...
namespace SoftwareAndServices {
	namespace Library {
		namespace Common {
			...
			Locale::Lc_Telephone::Lc_Telephone(Locale & Parent)
				: LcBase(Parent, LC_TELEPHONE_Cat)
			{
			}

			Locale::Lc_Telephone::~Lc_Telephone()
			{
			}

			Locale::Token_e
			Locale::Lc_Telephone::Parse(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseTelIntFmt(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseTelDomFmt(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseIntSelect(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseIntPrefix(Locale & Parent, File * Fp)
			{
			}
