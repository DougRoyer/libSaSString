...
namespace SoftwareAndServices {
	namespace Library {
		namespace Common {
			...
			Locale::Lc_Name::Lc_Name(Locale & Parent)
				: LcBase(Parent, LC_NAME_Cat)
			{
			}

			Locale::Lc_Name::~Lc_Name()
			{
			}

			Locale::Token_e
			Locale::Lc_Name::Parse(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseNameFmt(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseNameGen(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseNameMr(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseNameMrs(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseNameMiss(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseNameMs(Locale & Parent, File * Fp)
			{
			}
