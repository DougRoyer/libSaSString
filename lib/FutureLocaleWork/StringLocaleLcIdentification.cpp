...
namespace SoftwareAndServices {
	namespace Library {
		namespace Common {
			...
			Locale::Lc_Identification::Lc_Identification(Locale & Parent)
				: LcBase(Parent, LC_IDENTIFICATION_Cat)
			{
			}
			...
			Locale::Token_e
			Locale::Lc_Identification::Parse(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseTitle(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseAddress(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseContect(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseEmail(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseTel(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseFaxLanguage(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseTerritory(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseAudience(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseApplication(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseAbbreviation(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseRevision(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseDate(Locale & Parent, File * Fp)
			{
			}
