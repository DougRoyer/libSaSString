...
namespace SoftwareAndServices {
	namespace Library {
		namespace Common {
			...
			Locale::Lc_Numeric::Lc_Numeric(Locale & Parent)
				: LcBase(Parent, LC_NUMERIC_Cat)
			{
			}
			...
			Locale::Token_e
			Locale::Lc_Numeric::Parse(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseDecimalPoint(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseThousandsSep(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseGrouping(Locale & Parent, File * Fp)
			{
			}
