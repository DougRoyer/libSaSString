...
namespace SoftwareAndServices {
	namespace Library {
		namespace Common {
			...
			Locale::Lc_Messages::Lc_Messages(Locale & Parent)
				: LcBase(Parent, LC_MESSAGES_Cat)
			{
			}
			...
			Locale::Token_e
			Locale::Lc_Messages::Parse(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseYesExpr(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseNoExpr(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseYesStr(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseNoStr(Locale & Parent, File * Fp)
			{
			}
