...
namespace SoftwareAndServices {
	namespace Library {
		namespace Common {
			...
			Locale::Lc_Measurement::Lc_Measurement(Locale & Parent)
				: LcBase(Parent, LC_MEASUREMENT_Cat)
			{
			}

			Locale::Lc_Measurement::~Lc_Measurement()
			{
			}

			Locale::Token_e
			Locale::Lc_Measurement::Parse(Locale & Parent, File * Fp)
			{
			}

			Locale::Token_e
			Locale::_ParseMeasurement(Locale & Parent, File * Fp)
			{
			}
